        ...
        {borrar && (
            <div className="absolute top-0 left-0 w-full h-full bg-black/50 flex justify-center items-center z-10">
                <div className="bg-[var(--color-background)] p-6 rounded-xl border-2 border-[var(--color-border)]">
                    <h2 className="text-2xl font-bold mb-4">¿Estás seguro de que deseas borrar este egreso?</h2>
                    <div className="flex justify-end gap-4">
                        <button
                            className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition-colors"
                            onClick={() => {
                                borrarDatos.bind(null, 'egresos', egreso.id ?? 0)
                                setBorrar(false);
                            }}
                        >Borrar</button>
                        <button
            ...
            <li key={egreso.id} className='bg-white/10  p-3 rounded-lg border-[var(--color-border)] border-[0.1rem] grid grid-cols-[3rem_30rem_5rem_8rem_auto_10rem] gap-4'>
                ...
                <span className=' flex justify-center items-center gap-4 pr-4'>
                    ...
                    <a
                        ...
                        onClick={setBorrar.bind(null, true)}
                    >
